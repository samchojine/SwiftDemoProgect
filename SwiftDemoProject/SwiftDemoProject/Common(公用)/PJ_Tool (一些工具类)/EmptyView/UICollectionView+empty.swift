...
extension UICollectionView:SelfAware {
    ...
    private struct cvEmptyRuntimeKey {
    ...
    var emptyView:UIView? {
        set {
            objc_setAssociatedObject(self, UICollectionView.cvEmptyRuntimeKey.emptyKey!, newValue, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
        }
        get {
            return objc_getAssociatedObject(self, UICollectionView.cvEmptyRuntimeKey.emptyKey!) as? UIView
        }
    }
    ...
    var isfinish:Bool? {
        set {
            objc_setAssociatedObject(self, UICollectionView.cvEmptyRuntimeKey.isFirstTimeKey!, newValue, .OBJC_ASSOCIATION_ASSIGN)
        }
        get {
            return (objc_getAssociatedObject(self, UICollectionView.cvEmptyRuntimeKey.isFirstTimeKey!)as? Bool?)!
        }
    }
    ...
    private static let takeOnceTime: Void = {
        ...
        swizzlingForClass(UICollectionViewCell.self, originalSelector: originalSelector, swizzledSelector: swizzledSelector)
    }()
